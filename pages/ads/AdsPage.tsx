      ...
      <div className="mb-6 flex flex-col lg:flex-row gap-2 items-start lg:items-center">
        ...
        <div className="flex flex-1 items-center gap-2 w-full lg:w-auto">
          <FloatingSelect
            ...
            onChange={(value) =>
              setFilters((prev) => ({ ...prev, branchId: value || undefined }))
            }
            options={[
          ...
          <Button 
            ...
            disabled={!Object.keys(filters).some(key => filters[key as keyof AdFilter]) && !search}
            ...
            <div>
              <FloatingSelect
                ...
                onChange={(value) =>
                  setFormData((prev) => ({
                    ...prev,
                    type: value as "image" | "video" | "banner",
                  }))
                }
                options={[
                  { value: "image", label: "Hình ảnh" },
