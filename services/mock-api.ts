...
import { Branch, User, Kiosk, Advertisement, TransactionType } from '../types';
...
const mockAds: Advertisement[] = [
  {
    id: '1',
    code: 'AD001',
    title: 'Quảng cáo sản phẩm mới',
    description: 'Quảng cáo giới thiệu sản phẩm mới của ngân hàng',
    type: 'image',
    duration: 0,
    startDate: '2024-01-01T00:00:00Z',
    endDate: '2024-12-31T23:59:59Z',
    targetBranchIds: ['1'],
    targetBranchNames: ['Chi nhánh Hà Nội'],
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2024-01-01T00:00:00Z',
  },
  {
    ...
    description: 'Video giới thiệu các dịch vụ ngân hàng',
    type: 'video',
    duration: 30,
    startDate: '2024-02-01T00:00:00Z',
    endDate: '2024-02-28T23:59:59Z',
    targetBranchIds: ['2'],
    targetBranchNames: ['Chi nhánh TP.HCM'],
    isActive: true,
